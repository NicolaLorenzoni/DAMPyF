...
# =============================================================================
simulation_mode = "energy_transfer"  # Options: "energy_transfer", "linear_spectra"
...
# =============================================================================
same_local_environment = False                         # True if local environments are equal for all sites
pseudomode_parameter_file = "Loc_env.txt"  # Provide text file for the local environment (used when same_local_environment = True)
pseudomode_parameter_files = ["Loc_env.txt", None]  # List containing one filename or None per site when same_local_environment = False


# =============================================================================
# Initial state
# =============================================================================
initial_state_type = "eigenstate"  # None for linear_spectra; options: "site", "eigenstate", "polarized_pulse", "backup"
...
initial_eigenstate = 1             # Initially populated eigenstate, ordered by increasing energy (used if initial_state_type is "eigenstate")
...
# Output
# =============================================================================
output_identifier = "test_simulation"  # String identifier added to output filenames
